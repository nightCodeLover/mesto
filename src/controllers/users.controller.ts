...
export const createCreateUserController = (client: MongoClient) => {
  return async (
...
export const createUpdateUserController = (client: MongoClient) => {
  return async (
...
export const createUpdateUsersAvatarController = (client: MongoClient) => {
  return async (
